...
function fight(){
	...
	document.getElementById("jumbotron").innerHTML = "Roll the dice<br>to attack the Dragon!"
}
...
function flight(){
	...
	document.getElementById("jumbotron").innerHTML = "Run away and<br>Fight the Dragon later!"
}
